...
SECRET_KEY = 'cI[P<qoL9)\_|_*@{ER"p!"LN!Py$$WTB|Z"KfrTVh3l@ux+z_$tlbcrmYKe.0I{' # my_project/schedule/settings.py
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False # my_project/schedule/settings.py
ALLOWED_HOSTS = ['34.45.91.32'] # my_project/schedule/settings.py
# Config para postgresql
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'schedule_project_db', #database
        'USER': 'user_schedule',
        'PASSWORD': 'password_user_schedule',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
